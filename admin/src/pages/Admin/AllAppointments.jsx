            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage and review all appointments</p>
                        </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div className="hidden lg:grid lg:grid-cols-12 gap-4 px-6 py-4 bg-gray-50 border-b border-gray-200">
                        ...
                        <div className="col-span-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Patient</div>
                        ...
                        <div className="col-span-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Date & Time</div>
                        <div className="col-span-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Doctor</div>
                    ...
                    <div className="max-h-[70vh] overflow-y-auto">
                        {appointments.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="mt-1 text-gray-500">No appointments found at the moment.</p>
                            </div>
                        ) : (
                                    ...
                                    <div className="hidden lg:grid lg:grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-gray-50 transition-all duration-200 border-b border-gray-100">
                                        ...
                                        <div className="col-span-2 flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500">Dr. {item.docData.speciality}</p>
                                            </div>
                                        </div>
